...
import NoDataImage from "./../../assets/images/NoDataFound.png"; // นำเข้าภาพ "No Data Found"
...
const PurposePreference: React.FC<GlobalTableProps> = ({
  columns,
  data = [],
  pagination,
  handlePageChange,
  ...
  return (
    <div className="w-full overflow-x-auto pb-20" style={{ overflowX: "auto", width: "100%" }}>
              ...
              <tr key={trKey} {...trProps} className="text-sm">
                {headerGroup.headers.map((column: any, columnIndex: number) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`w-full flex items-center ${columnIndex <= 1 || columnIndex === 4 ? "justify-start" : "justify-center"}`}>
                  ...
                  {row.cells.map((cell: any, cellIndex: number) => {
                    ...
                    return (
                      <td key={cellKey} {...cellProps} className={`py-3 whitespace-nowrap px-4 border-b border-[#e5e7eb] ${
                        cellIndex === 0 || cellIndex === 4 ? "text-left" : "text-center"
                      }`}>
                        {cell.render("Cell")}
                      </td>
                    );
...
export default PurposePreference;

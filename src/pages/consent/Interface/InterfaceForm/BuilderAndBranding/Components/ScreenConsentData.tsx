...
} from "../../../../../../store/slices/sectionConsentDataBuilderAndBrandingSlice";
import {
  SortableContext,
  useSortable,
  arrayMove,
...
interface ScreenConsentDataProps {
...
const ScreenConsentData: React.FC<ScreenConsentDataProps> = ({
  ...
  const handleDragEnd = (event: any) => {
    ...
    if (active.id !== over.id) {
      ...
      dispatch(setSectionsConsentData(updatedSections));
    }
  };
  ...
  const addSection = (sectionName: string, show: boolean) => {
    ...
    dispatch(addSectionsConsentData(newItem));
  };
        ...
        <span
          ...
          onClick={() => {
            ...
            dispatch(setDataSelectionPreview({
              pageId: pageId,
              sectionId: id,
            })); // Save pageId and sectionId to Redux store
          }}
        >
          {text}
        </span>
...
export default ScreenConsentData;
